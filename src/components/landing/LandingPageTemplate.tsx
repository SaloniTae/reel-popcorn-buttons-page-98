...
const LandingPageTemplate = ({
  ...
  return <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center relative overflow-hidden">
      ...
      {isMobile && settings.show_footer_images && <>
          <div className="absolute bottom-[-38px] left-3 w-[217px] max-w-[217px] small-screen:w-[150px] small-screen:max-w-[120px] small-screen:bottom-[-30px] opacity-90 pointer-events-none overflow-hidden">
