  ...
  return <div className="mb-6">
      ...
      <div className="p-4 rounded-lg overflow-x-auto bg-neutral-700">
        <Table>
          <TableHeader>
            <TableRow>
              <TableHead className="bg-inherit">Button</TableHead>
          ...
          <TableBody>
            <TableRow className="bg-blue-50">
              ...
              <TableCell className="max-w-[200px] truncate">
                <div className="flex items-center">
                  ...
                  <Button variant="ghost" size="icon" className="h-6 w-6 ml-1" onClick={() => copyToClipboard(landingPage.shortUrl)}>
            ...
            return <TableRow key={childLink.id}>
                  ...
                  <TableCell className="max-w-[200px] truncate">
                    <div className="flex items-center">
                      ...
                      <Button variant="ghost" size="icon" className="h-6 w-6 ml-1" onClick={() => copyToClipboard(childLink.shortUrl)}>
                        <Copy className="h-3.5 w-3.5" />
                      </Button>
                    </div>
                  </TableCell>
