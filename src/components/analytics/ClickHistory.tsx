  ...
  return <div>
          ...
          <Table>
            ...
            <TableBody>
              {displayedClicks.map((click, index) => (
                <TableRow 
                  key={index} 
                  className="border-b border-apple-border hover:bg-apple-hover/30"
                >
      ...
      {clicks.length > 3 && (
        <Button 
          ...
          className="mt-4 w-full flex items-center justify-center text-apple-light bg-apple-glass hover:bg-apple-hover transition-colors"
        >
          {showAll ? (
